...
apt-get install -y galculator gdb gdbserver gettext-base gir1.2-glib-2.0 git git-core git-man gksu gnome-icon-theme-symbolic gpicview gvfs-backends gvfs-fuse
...
apt-get install -y xpdf xserver-xorg-video-fbturbo x2x xarchiver xfconf xinit xserver-xorg-video-fbdev
